<?php
    ...
    $sentencia = $bd->query("SELECT B.cedula, B.Nombre, B.Apellido1, B.Apellido2, A.numero, C.Descripcion_Direccion FROM telefono A JOIN persona B ON A.Persona_cedula = B.cedula JOIN direccion C ON B.cedula = C.Persona_cedula JOIN duenno D WHERE B.cedula = D.Persona_cedula;");
            ...
            <div class="row justify-content-center">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a class="text-success" href="editarDuenno.php?cedula=<?php echo $dato->cedula; ?>"><i class="bi bi-pencil-square"></i></a></td>
                                            <td><a onclick="return confirm('Estas seguro de eliminar?');" class="text-danger" href="assets/php/eliminarDuennoProceso.php?cedula=<?php echo $dato->cedula; ?>"><i class="bi bi-trash"></i></a></td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <form class="p-4" method="POST" action="assets/php/registroDuenno.php">
                            <div class="mb-3">
